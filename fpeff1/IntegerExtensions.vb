...
Module IntegerExtensions
   ...
   <Extension>
   Public Function GetBigEndianBytes(ByRef fromInteger As Integer) As Byte()
   ...
   <Extension>
   Public Function GetBigEndianBytes(ByRef fromInteger As Integer, ByVal resultLength As Integer) As Byte()
